...
$precioSeleccionado = $_GET['hasta'] ?? FALSE;

$catalogo = (new Disco())->catalogo_por_precio($precioSeleccionado);

// echo "<pre>";
// print_r($precioSeleccionado);
// echo "</pre>";
        ...
        <div class="container px-lg-5">
            ...
            <?PHP } else { ?>
                <div class="col my-md-5 text-center">
                    <h2 class="fs-3 text-error my-5">No se encontraron productos con ese precio</h2>
