...
$datosPOST = $_POST;
$catalogo = (new Disco())->buscador($datosPOST['termino']);
...
<div class=" d-flex justify-content-center py-5 px-3">
    <div>
        <h2 class="text-center mb-5 fw-bold fs-1"><?= $titulo ?>: <?= $datosPOST['termino'] ?> </h2>
        <div class="container px-lg-5">
            ...
            <?PHP } else { ?>
                <div class="col my-md-5 text-center">
                    <h2 class="fs-3 my-5 text-error">No se encontraron productos con el termino buscado</h2>
