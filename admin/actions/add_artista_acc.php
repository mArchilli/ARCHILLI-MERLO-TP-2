...
try {
    ...
    print_r($e);
    echo "</pre>";
    (new Alerta())->add_alerta('danger', 'Ocurrio un error al momento de agregar el artista. Por favor intentelo nuevamente o pongase en contacto con el administrador del sistema.');
    header('Location: ../index.php?sec=admin_artista');
}