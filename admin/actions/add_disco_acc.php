...
try {
    ...
    // print_r($e);
    // echo "</pre>";
    (new Alerta())->add_alerta('error', 'Ocurrio un error al momento de agregar el disco. Por favor intentelo nuevamente o pongase en contacto con el administrador del sistema.');
    header('Location: ../index.php?sec=admin_disco');
}